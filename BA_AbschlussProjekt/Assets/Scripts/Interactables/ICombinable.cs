...
public interface ICombinable
{
    ...
    /* Possible implementation:   
    {
        ...
        player.GUIInteractionFeedbackHandler.ActionDescription.text = "Click to combine " + currentlyHolding.DisplayName + " with " + DisplayName; //Inherit from InteractionFoundation to have access to DisplayName
