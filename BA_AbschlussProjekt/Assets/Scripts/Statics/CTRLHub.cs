...
public class CTRLHub : MonoBehaviour
{
    ...
    // Key to press for performing an alternative second action if possible
    private static KeyCode secondActionInteractKey = KeyCode.E;
    ...
    public static bool SecondInteract { get { return Input.GetKey(secondActionInteractKey); } }
    public static bool SecondInteractDown { get { return Input.GetKeyDown(secondActionInteractKey); } }
    public static bool SecondInteractUp { get { return Input.GetKeyUp(secondActionInteractKey); } }
    ...
    private void Awake()
    {
        ...
        secondActionInteractKey = ParseKeyCode("SecondInteraction", "E");
    }
